...
another option is to have the two go-routines note when they have finished with a give piece of data, either using a conditional (eg: wait/signal via sync package) or a second channel (the second channel seems more go-y)
*/
package main
